...
const Data = () => {
  return (
    <div className="home_data">
        ...
        <a href="#contact" className='group inline-flex gap-2 bg-[#333333] text-white px-7 hover:px-5 lg:px-8 lg:hover:px-6 py-4 hover:py-3 lg:py-5 lg:hover:py-4 rounded-2xl font-medium items-center hover:bg-slate-700 hover:text-xl'>
            Say Hello
