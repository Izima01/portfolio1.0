import '../../App.css';
import CV from '../../assets/Izima Obisike resume.pdf';
...
const About = () => {
  return (
    <div
      className='about section max-w-[968px] px-8 lg:px-0 mx-auto'
      id='about'
    >
      ...
      <div className='about_container grid items-center sm:gap-x-12 gap-y-10'>
        ...
        <div className='about_data'>
          <p className='about_desc p-0 mb-6 lg:mb-8'>
          ...
          <a
            href={CV}
            download=''
            className='button button--flex inline-flex gap-2'
          >
            Download CV
