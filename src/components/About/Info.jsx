...
const Info = () => {
  return (
    <div className="about_info grid items-center gap-3 mb-8 justify-center lg:justify-start overflow-x-hidden">
      ...
      <motion.div initial={{ x: 100, opacity: 0 }} whileInView={{ x:0, opacity: 1 }} transition={{ duration: 1 }} className="about_box bg-white border border-[#0000001a] rounded-xl flex flex-col items-center px-2 lg:px-5 py-3 lg:py-4">
